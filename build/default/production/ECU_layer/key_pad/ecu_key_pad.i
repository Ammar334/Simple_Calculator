...
# 11 "ECU_layer/key_pad/../../MCAL_layer/GPIO/../compiler.h"
...
# 11 "ECU_layer/key_pad/../../MCAL_layer/GPIO/../compiler.h" 2
...
# 28 "ECU_layer/key_pad/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum
{
    GPIO_PIN0 =0,
    GPIO_PIN1 ,
...
static const uint8 btn_values[4][4] = {{'7','8','9','/'}
                                                             ,{'4','5','6','*'}
                                                             ,{'1','2','3','-'}
                                                             ,{'#','0','=','+'}
};
...
Std_ReturnType keypad_get_value(const keypad_t *keypad,uint8 *value)
{
    ...
    uint8 row_counter=0,counter=0,coulmn_counter=0;
    ...
    else
    {
        for(row_counter=0;row_counter<4;row_counter++)
        {
            ...
            for(coulmn_counter=0;coulmn_counter<4;coulmn_counter++)
            {
